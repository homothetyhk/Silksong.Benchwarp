...
/// </summary>
public record FsmEventObstacleInfo(string ObjPath, string FsmEventName, ObstacleType Type, ObstacleSeverity Severity) : BehaviourObstacleInfo(ObjPath, nameof(PlayMakerFSM), true, Type, Severity)
{
