...
/// </summary>
public record TransitionObstacleInfo(string ObjPath, bool Enabled, ObstacleType Type, ObstacleSeverity Severity) : BehaviourObstacleInfo(ObjPath, nameof(TransitionPoint), Enabled, Type, Severity)
{
