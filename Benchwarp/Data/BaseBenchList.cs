...
public static class BaseBenchList
{
    ...
    public static BenchData ShootingGallery { get; } = new(BenchName: "Shooting Gallery", MenuArea: "The Marrow",
        RespawnInfo: new PDConditionalRespawnInfo(
            ...
            FalseRespawn: new RespawnInfo(SceneName: "Bone_12", RespawnMarkerName: "RestBench", RespawnType: 1, MapZone: MapZone.PATH_OF_BONE)));
    ...
    public static BenchData Sauna { get; } = new(BenchName: "Sauna", MenuArea: "Deep Docks",
                RespawnInfo: new RespawnInfo(SceneName: "Dock_10", RespawnMarkerName: "RestBench", RespawnType: 1, MapZone: MapZone.DOCKS));
    ...
    public static BenchData GatedToll { get; } = new(BenchName: "Gated Toll", MenuArea: "Far Fields",
                RespawnInfo: new RespawnInfo(SceneName: "Bone_East_15", RespawnMarkerName: "RestBench", RespawnType: 1, MapZone: MapZone.WILDS));
    ...
    public static BenchData ShakraGreymoor { get; } = new(BenchName: "Shakra", MenuArea: "Greymoor",
                RespawnInfo: new RespawnInfo(SceneName: "Greymoor_02", RespawnMarkerName: "RestBench", RespawnType: 1, MapZone: MapZone.GREYMOOR));
    public static BenchData BellshrineGreymoor { get; } = new(BenchName: "Bellshrine", MenuArea: "Greymoor",
                RespawnInfo: new RespawnInfo(SceneName: "Bellshrine_02", RespawnMarkerName: "RestBench", RespawnType: 1, MapZone: MapZone.GREYMOOR));
    ...
    public static BenchData BelowDining { get; } = new(BenchName: "Below Dining", MenuArea: "Choral Chambers",
                RespawnInfo: new RespawnInfo(SceneName: "Song_18", RespawnMarkerName: "RestBench", RespawnType: 1, MapZone: MapZone.CITY_OF_SONG));
    ...
    public static BenchData SurfaceAscent { get; } = new(BenchName: "Surface Ascent", MenuArea: "The Cradle",
                RespawnInfo: new RespawnInfo(SceneName: "Cradle_Destroyed_Challenge_Bench", RespawnMarkerName: "RestBench", RespawnType: 1, MapZone: MapZone.CRADLE));
